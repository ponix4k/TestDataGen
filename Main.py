...
from Products import (create_product_clothes, create_product_shoes, create_product_bedding, create_product_towel, multi_create_product_clothes,multi_create_product_towels , multi_create_product_bedding , multi_create_product_shoes,select_products)
import sqlite3
import string
